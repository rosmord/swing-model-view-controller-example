...
public class StudentNavigatorViewModel {
    ...
    /**
     * We share some values between all view models.
     */
    private final StudentSharedViewModel sharedViewModel;
    ...
    public void update() {
        if (id.getValue() != null) {
            ...
            StudentPersistenceFacade persistence = sharedViewModel.getStudentPersistenceFacade();
            StudentDTO updatedStudent = persistence.updateStudent(studentDTO);
            int pos = (Integer) position.getValue();
